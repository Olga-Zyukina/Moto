          ...
          <div class="col-9 col-lg-12">
            <div class="contacts-block">
              ...
              <div style="position: relative; overflow: hidden">
                <a
                  href="https://yandex.ru/maps/org/zhovner/1712560404/?utm_medium=mapframe&utm_source=maps"
                  style="
                    color: #eee;
                    font-size: 12px;
                    position: absolute;
                  ...
                  >Zhovner</a
                ><a
                  href="https://yandex.ru/maps/10997/krymsk/category/doors/184107677/?utm_medium=mapframe&utm_source=maps"
                  style="
                    color: #eee;
                    font-size: 12px;
                    position: absolute;
                  ...
                  >Двери в Крымске</a
                ><a
                  href="https://yandex.ru/maps/10997/krymsk/category/wrought_iron/184107695/?utm_medium=mapframe&utm_source=maps"
                  style="
                    color: #eee;
                    font-size: 12px;
                    position: absolute;
                    top: 28px;
                  "
                  >Кованые изделия в Крымске</a
                ><iframe
                  src="https://yandex.ru/map-widget/v1/-/CCUQJQTXOB"
                  width="100%"
                  height="400"
                  frameborder="1"
            ...
            <div class="contacts-block">
              ...
              <div style="position: relative; overflow: hidden">
                <a
                  ...
                  >Яндекс.Карты</a
                ><a
                  href="https://yandex.ru/maps/?from=api-maps&ll=38.947058%2C45.029390&mode=routes&origin=jsapi_2_1_78&rtext=~45.029390%2C38.946990&rtt=comparison&ruri=~&utm_medium=mapframe&utm_source=maps&z=21"
                  style="
                    color: #eee;
                    font-size: 12px;
                    position: absolute;
                    top: 14px;
                  "
                  >Малиновая улица, 8: как доехать на автомобиле, общественным
                  транспортом или пешком – Яндекс.Карты</a
                ><iframe
                  src="https://yandex.ru/map-widget/v1/-/CCUQJUVjPC"
                  width="100%"
                  height="400"
                  frameborder="1"
                  allowfullscreen="true"
